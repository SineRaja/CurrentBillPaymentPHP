...
<body>
    ...
    <div class="container" style="margin-top : 30px;   background: radial-gradient(#60efbc, #58d5c9); width: 90%;   padding: 20px;  border-radius: 10px;
        ...
        <form method="post">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" name="chargeperunitforday" id="chargeperunitforday" class="form-control" />
                </div>
            </div>
